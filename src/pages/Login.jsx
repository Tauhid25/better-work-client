...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col lg:flex-row pb-8 dark:bg-gray-800 dark:text-white px-4">
      <div className="card bg-base-100 mx-4 w-full max-w-sm py-5 dark:bg-gray-800 dark:text-white dark:border dark:border-white">
        <Helmet>
          <title>Better Work | Login</title>
        </Helmet>
      ...
      <div>
        <Lottie className="dark:bg-gray-800" loop={true} animationData={loginAnimation}>
