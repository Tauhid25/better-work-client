...
import logoImg from "../assets/tree.png";
...
const Navbar = () => {
  ...
  const navLinkClasses = ({ isActive }) =>
    isActive
      ? "text-[#007dff] dark:text-white border-b-2"
      : "text-black dark:text-white";

  return (
    <div className="px-4 md:px-12 lg:px-16 bg-gray-200 py-4 dark:bg-gray-800 dark:text-white">
      <div className="flex justify-between items-center">
        ...
        <ul className="hidden lg:flex items-center gap-8 text-lg">
          ...
          <li>
            <NavLink className={navLinkClasses} to="/upcoming-events">
              Upcoming Events
            </NavLink>
          </li>
        </ul>
          ...
          <div className="hidden lg:flex items-center gap-8 text-lg">
            ...
            {user && (
              <button
                ...
                className="bg-[#009fff] text-white px-4 py-1 rounded-lg text-lg hover:bg-[#007dff] cursor-pointer"
              >
                Logout
              </button>
            )}
            ...
            {!user && (
              <Link to="/auth/login">
                <button className="bg-[#009fff] text-white px-4 py-1 rounded-lg text-lg hover:bg-[#007dff] cursor-pointer">
                  LogIn
                </button>
              </Link>
            )}
          ...
          <div className="lg:hidden">
            <div className="space-y-4">
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                {!user && (
                  <Link to="/auth/login">
                    <button className="bg-[#009dff] text-white px-4 py-1 rounded-lg text-lg hover:bg-[#007dff] mr-4 cursor-pointer">
                      LogIn
                    </button>
                  </Link>
                )}
