  ...
  return (
    <div className="bg-gray-100 px-6 sm:px-10 md:px-16 dark:bg-gray-800 dark:text-white">
      ...
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 py-10">
        ...
        <div className="lg:col-span-3 text-center lg:text-left">
          ...
          <div className="text-sm leading-relaxed pt-4">
            <p>Email: support@betterwork.com</p>
            <p>Phone: +88 014328967</p>
            <p>Address: 123 Uttara, Tech City, Bangladesh</p>
          </div>
        ...
        {/* Company Links */}
        <div className="lg:col-span-3 text-center lg:text-left">
          <h3 className="text-lg font-bold pb-3">Quick Links</h3>
          <ul className="space-y-1">
            ...
            <li>
              <NavLink className={navLinkClasses} to="/upcomingEvents">
                Upcoming Events
              </NavLink>
            </li>
                 </ul>
        ...
        {/* Legal Links */}
        <div className="lg:col-span-3 text-center lg:text-left md:-mt-6 lg:mt-0">
      ...
      <div className="text-center pb-6 text-sm">
        <p>
          &copy; {new Date().getFullYear()} - All rights reserved by Better
          Work Community
        </p>
      </div>
    </div>
